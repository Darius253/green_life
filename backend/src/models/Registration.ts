...
const registrationSchema = new Schema<Iregistration>({
  ...
  Surplus: { type: String, default: null, enum: Surplus },
  NoOfDependants: { type: Number, required: true, default: 0 },
  CurrentlyServingaLoan: { type: String, required: true, enum: response },
  SourceOfLoan: { type: String, default: null, enum: Source },
  loanAmount: { type: Number, default: null },
  loanApproved: { type: String, enum: response, default: null },
  defaulted: { type: String, default: null, enum: response },
